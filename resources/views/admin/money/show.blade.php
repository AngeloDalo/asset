    ...
    <div class="container show ps-5 pb-5">
        ...
        <div class="row border border-success rounded-3 p-3">
            <div class="col-sm-12 col-md-12 col-lg-6">
                <img class="w-50 h-100 rounded-3" src="{{ asset('storage/' . $money->immagine) }}"
                    alt="{{ $money->nome }}">
            </div>
            <div class="col-sm- 12 col-md-12 col-lg-6">
        ...
        <a class="btn btn-success mt-5 text-white" href="{{ route('admin.money.index') }}">Mia Liquidit&agrave;</a>
    </div>
@endsection
